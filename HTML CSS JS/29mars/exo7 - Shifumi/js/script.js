...
/* 
    ...
    - Faire une fonction pour déclencher le choix au chic sur un bouton
...
function computerChoice(){
    ...
    if( userWin == 3 ){  
        ...
        document.querySelector('body').innerHTML = '<h1>Vous avez gagné !</h1><a href="index.html">Rejouez</a>';
    };

    if( computerWin == 3){
        // Afficher le message dans le body
        document.querySelector('body').innerHTML = '<h1>Vous avez perdu !</h1><a href="#">Rejouez</a>';
    };
