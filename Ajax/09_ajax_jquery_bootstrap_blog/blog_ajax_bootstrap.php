    ...
    <script>
        ...
        $(document).ready(function(){
            $("#form").on("submit", function(event){
                ...
                var parametres = $(this).serialize() + '&mode=enregistrer'; // this.serialize récupère toutes les values du formulaire à condition qu'ils aient un name, sous la bonne forme avec name = value
                console.log(url);
